...
class KaosodSpider(scrapy.Spider):
    ...
    #start_urls = ['https://www.khaosod.co.th/around-the-world-news']
    start_urls = ['https://www.khaosod.co.th/breaking-news', 
                  'https://www.khaosod.co.th/special-stories', 
                  'https://www.khaosod.co.th/hot-topics', 
                  'https://www.khaosod.co.th/around-thailand', 
                  'https://www.khaosod.co.th/around-the-world-news', 
                  'https://www.khaosod.co.th/entertainment', 
                  'https://www.khaosod.co.th/politics', 
                  'https://www.khaosod.co.th/economics', 
                  'https://www.khaosod.co.th/sports', 
                  'https://www.khaosod.co.th/newspaper-column', 
                  'https://www.khaosod.co.th/clips', 
                  'https://www.khaosod.co.th/monitor-news', 
                  'https://www.khaosod.co.th/lifestyle',
                  'https://www.khaosod.co.th/social-trend', 
                  'https://www.khaosod.co.th/car-vehicle', 
                  'https://www.khaosod.co.th/sci-tech', 
                  'https://www.khaosod.co.th/amulets', 
                  'https://www.khaosod.co.th/tv-guide']
    
    def parse(self, response):
        link_zone = response.selector.xpath('//div[@class="ud_loop_inner"]//div[@class="item-details"]//a')
        time_zone = response.selector.xpath('//div[@class="ud_loop_inner"]//div[@class="td-module-meta-info"]//time')
        times = time_zone.xpath('@datetime').extract()
        link = link_zone.xpath('@href').extract()
        #use_link = list(set(link))
        for href,datetime in zip(link, times):
    ...
    def parse_page(self, response):
        ...
        video_tag = response.selector.xpath
        ...
        if(len(paragraph) < 20):
            p_zone = response.selector.xpath('//div[@class="td-post-content"]//p//strong')
            paragraph = p_zone.xpath('text()').extract()
